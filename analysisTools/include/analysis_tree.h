...
namespace ana::tools
{
   ...
   * @details Specify the ROOT file which holds the TTrees, as well as where to find the signal/selected TTrees in that file,
  ...
  class analysis_tree
  {
    ...
    private:
      ...
      std::unique_ptr<TTree> backgroundTree;
